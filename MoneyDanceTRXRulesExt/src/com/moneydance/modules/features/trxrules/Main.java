package com.moneydance.modules.features.trxrules;
...
public class Main extends FeatureModule {
	...
	try {
	    context.registerFeature(this, "showconsole", getIcon("accountlist"), getName());
	} catch (Exception e) {
	...
	try {
	    ...
	    java.io.InputStream in = cl.getResourceAsStream("/com/moneydance/modules/features/trxrules/icon.gif");
	    if (in != null) {
